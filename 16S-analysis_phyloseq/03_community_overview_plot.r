...
# assign specific colour to make plot distuingishable
fill_values <- c("Aeromonadales" = "grey80",
					"Alteromonadales" = "orange",
					"Bacteroidia_unclassified" = "tomato", 
					"Betaproteobacteriales" = "pink",
					"Caulobacterales" = "black",
					"Chitinophagales" = "purple",
					"Corynebacteriales" = "darkblue",
					"Flavobacteriales" = "green",
					"Gammaproteobacteria_Incertae_Sedis" = "brown",
					"Sneathiellales" = "white",
					"Planctomycetales" = "orange2",
					"Parvibaculales" = "green3",
					"Pseudomonadales" = "grey30",
					"Rhizobiales" = "red",
					"Rhodobacterales" = "lightblue",
...
ggsave(file = paste(plot_folder, "fig_02_relative_community_biofilm_glyph_order_level_sorted_for_manuscript.png"), 
	   width = 16, 
	   height = 8)
...
length(levels(droplevels(sample_subset$class)))
length(levels(droplevels(sample_subset$order))) 
levels(droplevels(sample_subset$order))
...
fill_values <- c("Aeromonadales" = "grey80",
					...
					"Sphingomonadales" = "grey",
					"Thalassobaculales" = "blue2",
					"Verrucomicrobiales" = "black",
					"Xanthomonadales" = "darkred")	
...
ggsave(file = paste(plot_folder, "fig_02_relative_community_biofilm_control_order_level_sorted_for_manuscript.png"), 
	   width = 16, 
	   height = 8)