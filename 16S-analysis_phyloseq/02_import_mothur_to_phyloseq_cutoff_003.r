...
load("mothur_glyph_003.RData")

save.image("mothur_glyph_003.RData")
...
mothur_ps <- import_mothur(mothur_list_file = NULL, 
						   ...
						   cutoff = NULL, 
						   mothur_shared_file = "stability.trim.contigs.trim.good.unique.good.filter.unique.precluster.pick.pick.opti_mcc.unique_list.shared",
